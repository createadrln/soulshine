...
// Thumbnail sizes
add_image_size( 'bones-thumb-1040', 1040, 500, true );
...
function bones_register_sidebars() {
    ...
    register_sidebar(array(
        'id' => 'sidebar-posts',
        'name' => __( 'Sidebar Post List', 'bonestheme' ),
        'description' => __( 'Sidebar for Post Listing Page.', 'bonestheme' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>',
    ...
    register_sidebar(array(
		...
		'description' => __( 'A footer widget.', 'bonestheme' ),
	));
...
if ( ! function_exists( 'woocommerce_template_single_content' ) ) {
	...
	/**
	 * Output the product description (content).
	 *
	 * @access public
	 * @subpackage	Product
	 * @return void
