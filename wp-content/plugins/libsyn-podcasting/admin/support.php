			...
			<div class="inside" style="margin: 15px;">
				...
				<div class="inside supportDiv">
					<ul>
						...
						<li>and , then go to "Manage WordPress Plugins".
							Within your Libsyn account navigate to <strong>Click on the green arrow in the upper right hand corner</strong> then go to <strong>Manage Wordpress Plugins</strong> to continue.
