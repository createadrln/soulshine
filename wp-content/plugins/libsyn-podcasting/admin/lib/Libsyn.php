...
abstract class Libsyn implements Iterator, Countable, ArrayAccess  {
	...
	protected $plugin_version = "0.9.8.2";
	...
	public function retrieveApiById( $user_id , $disable_errors=false) {
		...
		if(!empty($data) && is_object($data)) {
			...
			//disable_errors if you expect this may return false (new setup or cleared settings)
			if($this->hasLogger && !$disable_errors) $this->logger->error("API:\trefreshToken:\tCould not retrieve API data set for $api_table_name.");
			return false;
		}
